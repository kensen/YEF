...
namespace YEF.Utility.Extensions
{
    public static class CollectionExtensions
    {
        ...
        /// <typeparam name="T">动态类型</typeparam>
        /// <param name="source">要排序的数据集</param>
        /// <param name="sortConfig">列表字段排序条件</param>
        /// <returns></returns>
        public static IOrderedQueryable<T> OrderBy<T>(this IQueryable<T> source, SortConfig sortConfig)
        {
            source.CheckNotNull("source");
            sortConfig.CheckNotNull("sortCondition");

            return source.OrderBy(sortConfig.SortField, sortConfig.ListSortDirection);
        }
        ...
        /// <param name="sortConfig">列表字段排序条件</param>
        /// <returns></returns>
        public static IOrderedQueryable<T> ThenBy<T>(this IOrderedQueryable<T> source, SortConfig sortConfig)
        {
            source.CheckNotNull("source");
            sortConfig.CheckNotNull("sortCondition");

            return source.ThenBy(sortConfig.SortField, sortConfig.ListSortDirection);
        }
