...
using YEF.Repositories.Migrations;
using YEF.Utility;
...
namespace YEF.Repositories
{
    ...
    public class DatabaseInitializer
    {
        ...
        public static void Initialize()
        {
            ...
            IDatabaseInitializer<YEFDbContext> initializer;
            ...
            {
                initializer = new MigrateDatabaseToLatestVersion<YEFDbContext, MigrationsConfiguration>();
            }
